...
dd <- read.csv("/Users/Frank/Documents/My scientific articles/2015 - Prediction horizons/ecopredtools/Petchey_etal_figures/data/fig5.r-squared.csv")
...
ee <- read.csv("/Users/Frank/Documents/My scientific articles/2015 - Prediction horizons/ecopredtools/Petchey_etal_figures/data/fig5.groups_real.csv")[,1:6]
str(ee)

## get cell volume assuming a sphere
ee$size <- 4/3*pi*((ee$approximate.size.lenght)^3)
